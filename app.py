...
def bypass_linkvertise(url):
    try:
        # Support all domains
        domains = ["linkvertise.com", "direct-link.net", "link-target.net", "link-to.net",
                   "link-center.net", "link-hub.net", "up-to-down.net"]
        ...
        # Step 1: Get link ID from static endpoint
        ...
        # Step 2: Build payload (exact from original repo + current timestamp)
        payload = {
